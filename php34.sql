...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='购物车' AUTO_INCREMENT=15 ;
...
CREATE TABLE IF NOT EXISTS `php34_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='商品分类表' AUTO_INCREMENT=32 ;

--
-- 转存表中的数据 `php34_category`
--

INSERT INTO `php34_category` (`id`, `cat_name`, `parent_id`) VALUES
(15, '家用电器', 0),
(16, '大家电', 15),
(14, '手机、数码', 0),
(17, '生活电器', 15),
...
(8, '312123', 15, 0, '0.00', '0.00', 0, 0, 0, '100.00', 1427817600, 1430409600, 'Admin/2015-04-26/553cadd781349.jpg', 'Admin/2015-04-26/thumb_0_553cadd781349.jpg', 1, 0, 0, 1, '', '', 0, 44, 0, 1429951685, '', 1),
...
CREATE TABLE IF NOT EXISTS `php34_goods_attr` (
  ...
  KEY `goods_id` (`goods_id`),
  KEY `attr_id` (`attr_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='商品属性' AUTO_INCREMENT=72 ;
